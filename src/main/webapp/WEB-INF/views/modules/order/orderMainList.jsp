...
<body>
	...
	<form:form id="searchForm" modelAttribute="orderMain" action="${ctx}/order/orderMain/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="orderMain">
			<tr>
				<td><a href="${ctx}/order/orderMain/form?id=${orderMain.id}">
					${orderMain.name}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="order:orderMain:edit"><td>
    				<a href="${ctx}/order/orderMain/form?id=${orderMain.id}">修改</a>
					<a href="${ctx}/order/orderMain/delete?id=${orderMain.id}" onclick="return confirmx('确认要删除该订单吗？', this.href)">删除</a>
